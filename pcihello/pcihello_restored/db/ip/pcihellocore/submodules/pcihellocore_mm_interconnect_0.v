...
module pcihellocore_mm_interconnect_0 (
	...
	wire  [114:0] green_leds_s1_agent_rp_data;                                            // green_leds_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [114:0] keys_s1_agent_rp_data;                                                  // keys_s1_agent:rp_data -> router_007:sink_data
	...
	wire          router_005_src_valid;                                                   // router_005:src_valid -> green_leds_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_005_src_data;                                                    // router_005:src_data -> green_leds_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                   // green_leds_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [8:0] router_005_src_channel;                                                 // router_005:src_channel -> green_leds_s1_rsp_width_adapter:in_channel
	wire          router_005_src_startofpacket;                                           // router_005:src_startofpacket -> green_leds_s1_rsp_width_adapter:in_startofpacket
	wire          router_005_src_endofpacket;                                             // router_005:src_endofpacket -> green_leds_s1_rsp_width_adapter:in_endofpacket
	wire          green_leds_s1_rsp_width_adapter_src_valid;                              // green_leds_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [150:0] green_leds_s1_rsp_width_adapter_src_data;                               // green_leds_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          green_leds_s1_rsp_width_adapter_src_ready;                              // rsp_demux_004:sink_ready -> green_leds_s1_rsp_width_adapter:out_ready
	wire    [8:0] green_leds_s1_rsp_width_adapter_src_channel;                            // green_leds_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          green_leds_s1_rsp_width_adapter_src_startofpacket;                      // green_leds_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          green_leds_s1_rsp_width_adapter_src_endofpacket;                        // green_leds_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	...
	wire          router_007_src_valid;                                                   // router_007:src_valid -> keys_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_007_src_data;                                                    // router_007:src_data -> keys_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                   // keys_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [8:0] router_007_src_channel;                                                 // router_007:src_channel -> keys_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                           // router_007:src_startofpacket -> keys_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                             // router_007:src_endofpacket -> keys_s1_rsp_width_adapter:in_endofpacket
	wire          keys_s1_rsp_width_adapter_src_valid;                                    // keys_s1_rsp_width_adapter:out_valid -> rsp_demux_006:sink_valid
	wire  [150:0] keys_s1_rsp_width_adapter_src_data;                                     // keys_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          keys_s1_rsp_width_adapter_src_ready;                                    // rsp_demux_006:sink_ready -> keys_s1_rsp_width_adapter:out_ready
	wire    [8:0] keys_s1_rsp_width_adapter_src_channel;                                  // keys_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	wire          keys_s1_rsp_width_adapter_src_startofpacket;                            // keys_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_006:sink_startofpacket
	wire          keys_s1_rsp_width_adapter_src_endofpacket;                              // keys_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_006:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                  // cmd_mux_004:src_valid -> green_leds_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> green_leds_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                  // green_leds_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> green_leds_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                          // cmd_mux_004:src_startofpacket -> green_leds_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                            // cmd_mux_004:src_endofpacket -> green_leds_s1_cmd_width_adapter:in_endofpacket
	...
	wire          cmd_mux_006_src_valid;                                                  // cmd_mux_006:src_valid -> keys_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_006_src_data;                                                   // cmd_mux_006:src_data -> keys_s1_cmd_width_adapter:in_data
	wire          cmd_mux_006_src_ready;                                                  // keys_s1_cmd_width_adapter:in_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> keys_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_006_src_startofpacket;                                          // cmd_mux_006:src_startofpacket -> keys_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                            // cmd_mux_006:src_endofpacket -> keys_s1_cmd_width_adapter:in_endofpacket
